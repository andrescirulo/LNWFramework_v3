...
public class LnwApplicationFilter implements Filter{
	...
	/**
	 * <p>
	 * Devuelve la direcciï¿½n de LOGOUT a la cual se redirige si se quiere
	 * acceder a una URL no excluï¿½da, sin haberse loggeado previamente.
	...
	/**
	 * <p>
	 * Utilidad para agregar al usuario de la aplicaciï¿½n
	 ...
	 * de uso existentes en la aplicaciï¿½n, declarados en GeneralConfig.xml
	 *
	 * @param lnwUser
	 */
	public static void addAllAccessToUser(LnwUser user) {
		...
		//tambien le damos acceso a los casos de uso genï¿½ricos que no estï¿½n en el menï¿½
