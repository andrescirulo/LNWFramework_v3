package net.latin.client.widget.documentoValidante.requisito.matriculaProvincial;
...
public class MatriculaProvincialPresenter extends AbstractRequisitoValidantePresenter<TomoFolioDisplay> {
	...
	public MatriculaProvincialPresenter(TomoFolioDisplay display) {
