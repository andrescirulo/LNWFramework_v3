...
public class TomoFolioPresenter extends AbstractRequisitoValidantePresenter<TomoFolioDisplay> {
	...
	public TomoFolioPresenter(TomoFolioDisplay display) {
